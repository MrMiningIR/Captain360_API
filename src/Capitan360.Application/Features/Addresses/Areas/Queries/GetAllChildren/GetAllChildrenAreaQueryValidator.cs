...
public class GetAllChildrenAreaQueryValidator : AbstractValidator<GetAllChildrenAreaQuery>
{
    ...
    public GetAllChildrenAreaQueryValidator()
    {
        RuleFor(r => r.ParentId)
            .GreaterThanOrEqualTo(0).WithMessage("شناسه والد باید بزرگتر یا برابر با 0 باشد");
