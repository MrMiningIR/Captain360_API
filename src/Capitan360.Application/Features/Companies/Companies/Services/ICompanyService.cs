...
{
    Task<ApiResponse<int>> CreateCompanyAsync(CreateCompanyCommand command, CancellationToken cancellationToken);

    Task<ApiResponse<int>> DeleteCompanyAsync(DeleteCompanyCommand command, CancellationToken cancellationToken);
    ...
    Task<ApiResponse<PagedResult<CompanyDto>>> GetAllCompanies(GetAllCompanyQuery query, CancellationToken cancellationToken);

    Task<ApiResponse<CompanyDto>> GetCompanyByIdAsync(GetCompanyByIdQuery query, CancellationToken cancellationToken);
}