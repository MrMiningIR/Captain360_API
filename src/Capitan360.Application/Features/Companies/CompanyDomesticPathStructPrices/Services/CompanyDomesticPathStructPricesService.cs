...
using Capitan360.Application.Features.Companies.CompanyDomesticPathStructPrices.Queries.GetAll;
using Capitan360.Application.Features.Companies.CompanyDomesticPathStructPrices.Queries.GetById;
using Capitan360.Application.Features.Companies.CompanyDomesticPathStructPrices.Queries.GetTableDataQuery;
...
namespace Capitan360.Application.Features.Companies.CompanyDomesticPathStructPrices.Services;
    ...
    : ICompanyDomesticPathStructPricesService
{
        ...
        CreateCompanyDomesticPathListStructPriceCommand command, CancellationToken cancellationToken)
    {
        ...
        var items = mapper.Map<List<Domain.Entities.Companies.CompanyDomesticPathStructPrice>>(command.CreateCompanyDomesticPathStructPrices);
        ...
        var municipalAreasItems =
            new List<Domain.Entities.Companies.CompanyDomesticPathStructPriceMunicipalArea>();
        for (int i = 0; i < command.CreateCompanyDomesticPathStructPrices.Count; i++)
        {
            ...
            {
                var mappedItems =
                    mapper.Map<List<Domain.Entities.Companies.CompanyDomesticPathStructPriceMunicipalArea>>(
    ...
    public async Task<ApiResponse<List<int>>> UpdateCompanyDomesticPathStructPriceAsync(UpdateCompanyDomesticPathListStructPriceCommand command, CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            if (insertItems.Any())
            {
                var newPrices = mapper.Map<List<Domain.Entities.Companies.CompanyDomesticPathStructPrice>>(insertItems);
            ...
            if (updateItems.Any())
            {
                ...
                var pricesToUpdate = new List<Domain.Entities.Companies.CompanyDomesticPathStructPrice>();
                var priceIdsToDelete = new List<int>();
            ...
            foreach (var item in command.UpdateCompanyDomesticPathStructPriceItems)
            {
                ...
                if (itemsToInsert.Any())
                {
                    var newMunicipalItems = mapper.Map<List<Domain.Entities.Companies.CompanyDomesticPathStructPriceMunicipalArea>>(itemsToInsert);
                    foreach (var newItem in newMunicipalItems)
                    {
                ...
                if (itemsToUpdate.Any())
                {
                    var updateMunicipalItems = mapper.Map<List<Domain.Entities.Companies.CompanyDomesticPathStructPriceMunicipalArea>>(itemsToUpdate);
    ...
    public async Task<ApiResponse<int>> CreateCompanyDomesticPathStructPriceAsync(CreateCompanyDomesticPathStructPriceCommand command, CancellationToken cancellationToken)
    {
        ...
        var price = mapper.Map<Domain.Entities.Companies.CompanyDomesticPathStructPrice>(command);
        if (price == null)
