    ...
    ) : ICompanyDomesticPathChargeService
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        //TODO
        var items = mapper.Map<List<CompanyDomesticPathCharge>>(command.ChargeItems);
        ...
        CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            {
                var newPrices = mapper.Map<List<CompanyDomesticPathCharge>>(companyDomesticPathChargeInsertList);
            ...
            if (companyDomesticPathChargeUpdateList.Any())
            {
                ...
                var pricesToUpdate = new List<CompanyDomesticPathCharge>();
