...
public class UpdateCompanyDomesticPathReceiverCompanyCommandValidator : AbstractValidator<UpdateCompanyDomesticPathReceiverCompanyCommand>
{
    public UpdateCompanyDomesticPathReceiverCompanyCommandValidator()
    {
        RuleFor(x => x.Id)
        ...
        RuleFor(x => x.ReceiverCompanyUserInsertedTelephone)
            .MaximumLength(30).When(x => x.ReceiverCompanyUserInsertedName != null)
