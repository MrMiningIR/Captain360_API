...
public class CreateCompanyDomesticWaybillPeriodCommandValidator : AbstractValidator<CreateCompanyDomesticWaybillPeriodCommand>
{
    public CreateCompanyDomesticWaybillPeriodCommandValidator()
    {
