...
public class UpdateCompanyDomesticWaybillPeriodCommandValidator : AbstractValidator<UpdateCompanyDomesticWaybillPeriodCommand>
{
    public UpdateCompanyDomesticWaybillPeriodCommandValidator()
    {
        RuleFor(x => x.Id)
