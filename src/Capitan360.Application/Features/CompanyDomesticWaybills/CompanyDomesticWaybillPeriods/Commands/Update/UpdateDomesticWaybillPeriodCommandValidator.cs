...
public class UpdateDomesticWaybillPeriodCommandValidator : AbstractValidator<UpdateDomesticWaybillPeriodCommand>
{
    public UpdateDomesticWaybillPeriodCommandValidator()
    {
        RuleFor(x => x.Id)
