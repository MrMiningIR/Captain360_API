...
public class BackDomesticWaybillFormBackToSenderCompanyStateFromDesktopCommandValidation : AbstractValidator<BackDomesticWaybillFormBackToSenderCompanyStateFromDesktopCommand>
{
    public BackDomesticWaybillFormBackToSenderCompanyStateFromDesktopCommandValidation()
    {
        RuleFor(x => x.No)
