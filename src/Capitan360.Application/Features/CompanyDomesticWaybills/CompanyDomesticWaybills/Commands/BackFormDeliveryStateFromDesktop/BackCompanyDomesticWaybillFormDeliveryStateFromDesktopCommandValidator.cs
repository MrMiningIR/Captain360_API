...
public class BackCompanyDomesticWaybillFormDeliveryStateFromDesktopCommandValidator : AbstractValidator<BackCompanyDomesticWaybillFormDeliveryStateFromDesktopCommand>
{
    public BackCompanyDomesticWaybillFormDeliveryStateFromDesktopCommandValidator()
    {
        RuleFor(x => x.No)
