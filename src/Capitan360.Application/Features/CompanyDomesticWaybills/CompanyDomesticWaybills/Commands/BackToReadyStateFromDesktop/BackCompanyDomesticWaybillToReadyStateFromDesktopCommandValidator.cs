...
public class BackCompanyDomesticWaybillToReadyStateFromDesktopCommandValidator : AbstractValidator<BackCompanyDomesticWaybillToReadyStateFromDesktopCommand>
{
    public BackCompanyDomesticWaybillToReadyStateFromDesktopCommandValidator()
    {
        RuleFor(x => x.No)
