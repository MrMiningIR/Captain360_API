...
public class IssueDomesticWaybillCommandValidator : AbstractValidator<IssueCompanyDomesticWaybillCommand>
{
    public IssueDomesticWaybillCommandValidator()
    {
        RuleFor(x => x.No)
        ...
        RuleFor(x => x.CustomerSenderNameFamily)
            .MaximumLength(100)
            .When(x => !string.IsNullOrEmpty(x.CustomerSenderNameFamily))
...
//
//
//    // متون اختیاری با طول مشخص
//    RuleFor(x => x.BikeDeliveryInSenderCompanyId).MaximumLength(450);
//    RuleFor(x => x.BikeDeliveryInSenderCompanyAgent).MaximumLength(100);
//    RuleFor(x => x.BikeDeliveryInReceiverCompanyId).MaximumLength(450);
//    RuleFor(x => x.BikeDeliveryInReceiverCompanyAgent).MaximumLength(100);
//    RuleFor(x => x.EntranceDeliveryPerson).MaximumLength(100);
//    RuleFor(x => x.DescriptionReceiverCustomer).MaximumLength(500);
