...
namespace Capitan360.Application.Features.CompanyDomesticWaybills.CompanyDomesticWaybills.Commands.Update;

public class UpdateCompanyDomesticWaybillCommandValidator : AbstractValidator<UpdateCompanyDomesticWaybillCommand>
{
    public UpdateCompanyDomesticWaybillCommandValidator()
    {
        RuleFor(x => x.Id)
