...
public class UpdateDomesticWaybillFromDesktopCommandValidator : AbstractValidator<UpdateDomesticWaybillFromDesktopCommand>
{
    public UpdateDomesticWaybillFromDesktopCommandValidator()
    {
        RuleFor(x => x.No)
            .GreaterThan(0).WithMessage("شماره فرم بارنامه باید بزرگتر از صفر باشد");
