...
public class GetAllCompanyDomesticWaybillReceiverCompanyQueryValidator : AbstractValidator<GetAllCompanyDomesticWaybillReceiverCompanyQuery>
{
    ...
    public GetAllCompanyDomesticWaybillReceiverCompanyQueryValidator()
    {
        RuleFor(x => x.No)
