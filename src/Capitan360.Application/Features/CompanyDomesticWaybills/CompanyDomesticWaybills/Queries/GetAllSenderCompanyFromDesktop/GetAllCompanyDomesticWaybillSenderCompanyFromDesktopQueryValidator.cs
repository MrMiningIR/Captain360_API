...
using Capitan360.Application.Features.CompanyDomesticWaybills.CompanyDomesticWaybills.Queries.GetAllSenderCompany;
...
public class GetAllCompanyDomesticWaybillSenderCompanyFromDesktopQueryValidator : AbstractValidator<GetAllCompanyDomesticWaybillSenderCompanyFromDesktopQuery>
{
    ...
    public GetAllCompanyDomesticWaybillSenderCompanyFromDesktopQueryValidator()
    {
        RuleFor(x => x.No)
