    ...
    : ICompanyInsuranceChargeService
{
    public async Task<ApiResponse<List<int>>> CreateCompanyInsuranceChargeAsync(CreateCompanyInsuranceChargeListCommand? command, CancellationToken cancellationToken)
    {
        ...
        var companyInsuranceEntities = mapper.Map<List<CompanyInsuranceCharge>>(command.CompanyInsuranceChargeList);
        ...
        CancellationToken cancellationToken)
    {
        ...
        if (mainUpdateList.Any())
        {
            ...
            var mainItemsShouldBeUpdated = new List<CompanyInsuranceCharge>();
        ...
        {
            var newMainItems = mapper.Map<List<CompanyInsuranceCharge>>(mainInsertList);
