...
public class CreateCompanyManifestFormPeriodCommandValidator : AbstractValidator<CreateCompanyManifestFormPeriodCommand>
{
    public CreateCompanyManifestFormPeriodCommandValidator()
    {
