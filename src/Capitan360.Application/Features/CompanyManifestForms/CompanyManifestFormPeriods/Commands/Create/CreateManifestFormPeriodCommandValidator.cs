...
public class CreateManifestFormPeriodCommandValidator : AbstractValidator<CreateManifestFormPeriodCommand>
{
    public CreateManifestFormPeriodCommandValidator()
    {
