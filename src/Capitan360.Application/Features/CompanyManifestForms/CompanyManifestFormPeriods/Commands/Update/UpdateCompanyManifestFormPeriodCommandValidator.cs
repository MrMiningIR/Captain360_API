...
public class UpdateCompanyManifestFormPeriodCommandValidator : AbstractValidator<UpdateCompanyManifestFormPeriodCommand>
{
    public UpdateCompanyManifestFormPeriodCommandValidator()
    {
        RuleFor(x => x.Id)
