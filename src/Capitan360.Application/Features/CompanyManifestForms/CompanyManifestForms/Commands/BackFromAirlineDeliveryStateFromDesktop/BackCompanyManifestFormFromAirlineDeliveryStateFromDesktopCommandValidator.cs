...
public class BackCompanyManifestFormFromAirlineDeliveryStateFromDesktopCommandValidator : AbstractValidator<BackCompanyManifestFormFromAirlineDeliveryStateFromDesktopCommand>
{
    public BackCompanyManifestFormFromAirlineDeliveryStateFromDesktopCommandValidator()
    {
        RuleFor(x => x.No)
