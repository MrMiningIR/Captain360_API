...
public class BackFromReceivedAtReceiverCompanyStateFromDesktopCommandValidator : AbstractValidator<BackFromReceivedAtReceiverCompanyStateFromDesktopCommand>
{
