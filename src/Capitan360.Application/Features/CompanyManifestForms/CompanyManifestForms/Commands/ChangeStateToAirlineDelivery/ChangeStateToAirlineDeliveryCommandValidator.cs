...
public class ChangeStateToAirlineDeliveryCommandValidator : AbstractValidator<ChangeStateToAirlineDeliveryCommand>
{
    public ChangeStateToAirlineDeliveryCommandValidator()
    {
        RuleFor(x => x.Id)
