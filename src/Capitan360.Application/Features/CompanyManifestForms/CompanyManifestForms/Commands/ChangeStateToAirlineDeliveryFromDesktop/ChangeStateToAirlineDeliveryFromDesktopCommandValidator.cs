...
public class ChangeStateToAirlineDeliveryFromDesktopCommandValidator : AbstractValidator<ChangeStateToAirlineDeliveryFromDesktopCommand>
{
    public ChangeStateToAirlineDeliveryFromDesktopCommandValidator()
    {
        RuleFor(x => x.No)
