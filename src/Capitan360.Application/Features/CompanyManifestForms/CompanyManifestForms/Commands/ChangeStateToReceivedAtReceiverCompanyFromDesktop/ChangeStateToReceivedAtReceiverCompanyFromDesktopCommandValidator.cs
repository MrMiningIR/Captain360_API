...
public class ChangeStateToReceivedAtReceiverCompanyFromDesktopCommandValidator : AbstractValidator<ChangeStateCompanyManifestFormToReceivedAtReceiverCompanyFromDesktopCommand>
{
    public ChangeStateToReceivedAtReceiverCompanyFromDesktopCommandValidator()
    {
        RuleFor(x => x.No)
