...
public class DetachMasterWaybillFromCompanyManifestFormFromDesktopCommandValidator : AbstractValidator<DetachMasterWaybillFromCompanyManifestFormFromDesktopCommand>
{
    public DetachMasterWaybillFromCompanyManifestFormFromDesktopCommandValidator()
    {
        RuleFor(x => x.No)
