...
public class UpdateManiFestFormFromDesktopCommandValidator : AbstractValidator<UpdateManiFestFormFromDesktopCommand>
{
    public UpdateManiFestFormFromDesktopCommandValidator()
    {
        RuleFor(x => x.No)
