...
public record GetAllCompanyManifestFormReceiverCompanyFromDesktopQuery(
    [property: DefaultValue("")] string SearchPhrase = "",
    [property: DefaultValue("")] string SortBy = "",
    [property: DefaultValue(0)] long No = 0,
    [property: DefaultValue("")] string CompanyReceiverCaptain360Code = "",
    [property: DefaultValue("")] string CompanySenderCaptain360Code = "",
    [property: DefaultValue("")] string SourceCityCaptainCargoCode = "",
