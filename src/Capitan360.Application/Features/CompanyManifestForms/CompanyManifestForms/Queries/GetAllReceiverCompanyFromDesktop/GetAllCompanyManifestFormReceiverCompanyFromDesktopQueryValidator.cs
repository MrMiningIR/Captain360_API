...
namespace Capitan360.Application.Features.CompanyManifestForms.CompanyManifestForms.Queries.GetAllReceiverCompanyFromDesktop;

public class GetAllCompanyManifestFormReceiverCompanyFromDesktopQueryValidator : AbstractValidator<GetAllCompanyManifestFormReceiverCompanyFromDesktopQuery>
{
    ...
    public GetAllCompanyManifestFormReceiverCompanyFromDesktopQueryValidator()
    {
        RuleFor(x => x.No)
