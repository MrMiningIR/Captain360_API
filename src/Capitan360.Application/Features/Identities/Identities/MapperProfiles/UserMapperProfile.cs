...
public class UserMapperProfile : Profile
{
    public UserMapperProfile()
    {
        CreateMap<CreateUserCommand, User>()
             .ForMember(x => x.Tell, opt => opt.MapFrom(y => y.PhoneNumber))
        ...
        CreateMap<User, UserDto>()
            ...
            .ForMember(dest => dest.TypeOfFactorInSamanehMoadianId,
                opt => opt.MapFrom(src => src.TypeOfFactorInSamanehMoadianId))
