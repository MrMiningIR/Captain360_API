...
public class AssignUserPermissionCommandsValidator : AbstractValidator<AssignUserPermissionCommands>
{
    public AssignUserPermissionCommandsValidator()
    {
        ...
        RuleForEach(x => x.PermissionList)
            .SetValidator(new AssignUserPermissionCommandValidator());
    }
}