...
namespace Capitan360.Application.Services.AddressService.Queries.GetAllAreas;

public class GetAllAreaQueryValidator : AbstractValidator<GetAllAreaQuery>
{
    ...
    public GetAllAreaQueryValidator()
    {
