...
public class UpdateCompanyInsuranceChargeCommandValidator : AbstractValidator<UpdateCompanyInsuranceChargeCommand>
{
    public UpdateCompanyInsuranceChargeCommandValidator()
    {
        RuleFor(x => x.Rate)
