...
public interface IPermissionService
{
    ...
    public class PermissionProfile : Profile
    {
        ...
        {
            CreateMap<Domain.Entities.AuthorizationEntity.Permission, PermissionDto>();
        }
    }
    ...
    Task<ApiResponse<List<Domain.Entities.AuthorizationEntity.Permission>>> GetDbPermissions(CancellationToken ct);
