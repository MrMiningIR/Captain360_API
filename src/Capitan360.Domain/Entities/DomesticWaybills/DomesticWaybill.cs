...
public class DomesticWaybill : BaseEntity
{
    ...
    [ForeignKey(nameof(DomesticWaybillPeriod))]
    public int? DomesticWaybillPeriodId { get; set; }
    public DomesticWaybillPeriod? DomesticWaybillPeriod { get; set; }
    ...
    public string? DescriptionSenderComapny { get; set; }
