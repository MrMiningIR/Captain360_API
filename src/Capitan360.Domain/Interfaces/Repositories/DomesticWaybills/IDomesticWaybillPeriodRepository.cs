...
public interface IDomesticWaybillPeriodRepository 
{
    ...
    Task<DomesticWaybillPeriod?> GetDomesticWaybillPeriodByIdAsync(int domesticWaybillPeriodId, bool loadData, bool tracked, CancellationToken cancellationToken);

    Task<IReadOnlyList<DomesticWaybillPeriod>?> GetDomesticWaybillPeriodByCompanyIdAsync(int companyId, CancellationToken cancellationToken);
    ...
    Task<DomesticWaybillPeriod?> GetDomesticWaybillPeriodByCodeAsync(string domesticWaybillPeriodCode, int companyId, bool loadData, bool tracked, CancellationToken cancellationToken);
}
