...
public class CompanyDomesticPathsConfigurations : IEntityTypeConfiguration<CompanyDomesticPaths>
{
    public void Configure(EntityTypeBuilder<CompanyDomesticPaths> builder)
    {
