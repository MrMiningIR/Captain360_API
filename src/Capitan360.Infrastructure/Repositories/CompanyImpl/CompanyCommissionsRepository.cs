...
public class CompanyCommissionsRepository(ApplicationDbContext dbContext, IUnitOfWork unitOfWork) : ICompanyCommissionsRepository
{
    ...
    public async Task<CompanyCommissions?> GetCompanyCommissionsByIdAsync(int companyCommissionsId, bool tracked, bool loadData, CancellationToken cancellationToken)
    {
    ...
    public async Task DeleteCompanyCommissionsAsync(CompanyCommissions companyCommissions)
    {
        await Task.Yield();
    }
    ...
    public async Task<CompanyCommissions?> GetCompanyCommissionsByCompanyIdAsync(int companyId, bool tracked, bool loadData, CancellationToken cancellationToken)
    {
        IQueryable<CompanyCommissions> query = dbContext.CompanyCommissions;
