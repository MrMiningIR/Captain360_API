...
{
    public async Task<Domain.Entities.DomesticWaybillEntity.DomesticWaybill?> GetDomesticWaybillByIdAsync(int domesticWaybillId, bool tracked, bool loadDataGeneralData, bool loadDataSenderCompany, bool loadDataReceiverCompany, CancellationToken cancellationToken)
    {
        IQueryable<Domain.Entities.DomesticWaybillEntity.DomesticWaybill> query = dbContext.DomesticWaybills;
    ...
    public async Task<Domain.Entities.DomesticWaybillEntity.DomesticWaybill?> GetDomesticWaybillByNoAsync(long domesticWaybillNo, bool tracked, bool loadDataGeneralData, bool loadDataSenderCompany, bool loadDataReceiverCompany, CancellationToken cancellationToken)
    {
        IQueryable<Domain.Entities.DomesticWaybillEntity.DomesticWaybill> query = dbContext.DomesticWaybills;
    ...
    public async Task<Domain.Entities.DomesticWaybillEntity.DomesticWaybill?> GetDomesticWaybillByNoAndCompanySenderIdAsync(long domesticWaybillNo, int companySenderId, bool tracked, bool loadDataGeneralData, bool loadDataSenderCompany, bool loadDataReceiverCompany, CancellationToken cancellationToken)
    {
        IQueryable<Domain.Entities.DomesticWaybillEntity.DomesticWaybill> query = dbContext.DomesticWaybills;
    ...
    public async Task<Domain.Entities.DomesticWaybillEntity.DomesticWaybill?> GetDomesticWaybillByNoAndCompanyReceiverIdAsync(long domesticWaybillNo, int companyReceiverId, bool tracked, bool loadDataGeneralData, bool loadDataSenderCompany, bool loadDataReceiverCompany, CancellationToken cancellationToken)
    {
        IQueryable<Domain.Entities.DomesticWaybillEntity.DomesticWaybill> query = dbContext.DomesticWaybills;
    ...
    public async Task<int> InsertDomesticWaybillAsync(Capitan360.Domain.Entities.DomesticWaybillEntity.DomesticWaybill domesticWaybill, CancellationToken cancellationToken)
    {
    ...
    {
        dbContext.DomesticWaybillPackageTypes.RemoveRange(dbContext.DomesticWaybillPackageTypes.Where(item => item.DomesticWaybillId == domesticWaybillId).ToList());
        dbContext.DomesticWaybills.Remove(await dbContext.DomesticWaybills.SingleOrDefaultAsync(item => item.Id == domesticWaybillId, cancellationToken));
        await unitOfWork.SaveChangesAsync(cancellationToken);
    }

    public async Task<List<int>> GetWaybillIdByManifestFormIdAsync(int manifestFormId, CancellationToken cancellationToken)
    {
        return await dbContext.DomesticWaybills.Where(item => item.ManifestFormId.HasValue && item.ManifestFormId == manifestFormId).Select(item => item.Id).ToListAsync(cancellationToken);
    }
    ...
    {
        return await dbContext.DomesticWaybills.Where(item => item.DomesticWaybillPeriodId == domesticWaybillPeriodId && item.No < startNumber).Select(item => item.Id).ToListAsync(cancellationToken);
    }
    ...
    {
        return await dbContext.DomesticWaybills.Where(item => item.DomesticWaybillPeriodId == domesticWaybillPeriodId && item.No > endNumber).Select(item => item.Id).ToListAsync(cancellationToken);
    }
    ...
    {
        return await dbContext.DomesticWaybills.Where(item => item.DomesticWaybillPeriodId == domesticWaybillPeriodId).Select(item => item.Id).ToListAsync(cancellationToken);
    }
